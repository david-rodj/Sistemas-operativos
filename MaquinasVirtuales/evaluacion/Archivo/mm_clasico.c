...
#define DATA_SIZE (1024*1024*64*3) // Definición del tamaño total de datos en memoria

pthread_mutex_t MM_mutex; // Mutex para controlar el acceso a recursos compartidos
static double MEM_CHUNK[DATA_SIZE]; // Chunk de memoria para almacenar las matrices
...
void *mult_thread(void *variables) {
	...
	int ini = (N / nH) * idH; // Índice inicial para
